...
module.exports = require('./_shared.js')('native-function-to-string', Function.toString);
...
var SRC = require('./_uid.js')('src');
var $toString = require('./_function-to-string.js');
...
'use strict';
var $export = require('./_export.js');
var $filter = require('./_array-methods.js')(2);
...
var $export = require('./_export.js');
var $find = require('./_array-methods.js')(5);
var KEY = 'find';
var forced = true;
...
var $export = require('./_export.js');
var $find = require('./_array-methods.js')(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
var toLength = require('./_to-length.js');
var ctx = require('./_ctx.js');
var IS_CONCAT_SPREADABLE = require('./_wks.js')('isConcatSpreadable');
...
var $export = require('./_export.js');
var flattenIntoArray = require('./_flatten-into-array.js');
var toObject = require('./_to-object.js');
var toLength = require('./_to-length.js');
var aFunction = require('./_a-function.js');
var arraySpeciesCreate = require('./_array-species-create.js');
...
require('./_add-to-unscopables.js')('flatMap');
...
var $export = require('./_export.js');
var $includes = require('./_array-includes.js')(true);
...
'use strict';
var $export = require('./_export.js');
var $map = require('./_array-methods.js')(1);
...
var isObject = require('./_is-object.js');
var getPrototypeOf = require('./_object-gpo.js');
var HAS_INSTANCE = require('./_wks.js')('hasInstance');
...
var isObject = require('./_is-object.js');
var setPrototypeOf = require('./_set-proto.js').set;
...
var isObject = require('./_is-object.js');
var fails = require('./_fails.js');
var $iterDetect = require('./_iter-detect.js');
var setToStringTag = require('./_set-to-string-tag.js');
var inheritIfRequired = require('./_inherit-if-required.js');
...
var $export = require('./_export.js');
var log1p = require('./_math-log1p.js');
var sqrt = Math.sqrt;
...
var $export = require('./_export.js');
var sign = require('./_math-sign.js');
...
// 20.2.2.14 Math.expm1(x)
var $export = require('./_export.js');
var $expm1 = require('./_math-expm1.js');
...
$export($export.S, 'Math', { fround: require('./_math-fround.js') });
...
$export($export.S, 'Math', { sign: require('./_math-sign.js') });
...
var defined = require('./_defined.js');
var fails = require('./_fails.js');
var spaces = require('./_string-ws.js');
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
var gOPD = require('./_object-gopd.js').f;
var dP = require('./_object-dp.js').f;
var $trim = require('./_string-trim.js').trim;
var NUMBER = 'Number';
var $Number = global[NUMBER];
var Base = $Number;
var proto = $Number.prototype;
// Opera ~12 has broken Object#toString
var BROKEN_COF = cof(require('./_object-create.js')(proto)) == NUMBER;
...
var $export = require('./_export.js');
var _isFinite = require('./_global.js').isFinite;
...
var $export = require('./_export.js');
var isInteger = require('./_is-integer.js');
var abs = Math.abs;
...
var $export = require('./_export.js');
var $parseFloat = require('./_parse-float.js');
...
var $export = require('./_export.js');
var $parseInt = require('./_parse-int.js');
...
var getKeys = require('./_object-keys.js');
var toIObject = require('./_to-iobject.js');
var isEnum = require('./_object-pie.js').f;
...
var $export = require('./_export.js');
var $entries = require('./_object-to-array.js')(true);
...
var gOPS = require('./_object-gops.js');
var anObject = require('./_an-object.js');
var Reflect = require('./_global.js').Reflect;
...
var $export = require('./_export.js');
var ownKeys = require('./_own-keys.js');
var toIObject = require('./_to-iobject.js');
...
// https://github.com/tc39/proposal-object-values-entries
var $export = require('./_export.js');
var $values = require('./_object-to-array.js')(false);
...
var aFunction = require('./_a-function.js');
var anObject = require('./_an-object.js');
var rApply = (require('./_global.js').Reflect || {}).apply;
...
var isObject = require('./_is-object.js');
var fails = require('./_fails.js');
var bind = require('./_bind.js');
var rConstruct = (require('./_global.js').Reflect || {}).construct;
...
var $export = require('./_export.js');
var getProto = require('./_object-gpo.js');
var anObject = require('./_an-object.js');
...
var $export = require('./_export.js');
var setProto = require('./_set-proto.js');
...
var regexpFlags = require('./_flags.js');
...
'use strict';
var regexpExec = require('./_regexp-exec.js');
require('./_export.js')({
  target: 'RegExp',
  proto: true,
...
var anObject = require('./_an-object.js');
var toLength = require('./_to-length.js');
var advanceStringIndex = require('./_advance-string-index.js');
var regExpExec = require('./_regexp-exec-abstract.js');

// @@match logic
require('./_fix-re-wks.js')('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
require('./_fix-re-wks.js')('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
var advanceStringIndex = require('./_advance-string-index.js');
var toLength = require('./_to-length.js');
var callRegExpExec = require('./_regexp-exec-abstract.js');
var regexpExec = require('./_regexp-exec.js');
var fails = require('./_fails.js');
var $min = Math.min;
var $push = [].push;
...
// @@split logic
require('./_fix-re-wks.js')('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
  if (
    'abbc'[$SPLIT](/(b)*/)[1] == 'c' ||
...
var anObject = require('./_an-object.js');
var sameValue = require('./_same-value.js');
var regExpExec = require('./_regexp-exec-abstract.js');

// @@search logic
require('./_fix-re-wks.js')('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
'use strict';
var $export = require('./_export.js');
var $at = require('./_string-at.js')(false);
...
var $export = require('./_export.js');
var toLength = require('./_to-length.js');
var context = require('./_string-context.js');
...
var toLength = require('./_to-length.js');
var repeat = require('./_string-repeat.js');
var defined = require('./_defined.js');
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = require('./_export.js');
var $pad = require('./_string-pad.js');
var userAgent = require('./_user-agent.js');
...
var toInteger = require('./_to-integer.js');
var toLength = require('./_to-length.js');
var toIndex = require('./_to-index.js');
var gOPN = require('./_object-gopn.js').f;
var dP = require('./_object-dp.js').f;
var arrayFill = require('./_array-fill.js');
var setToStringTag = require('./_set-to-string-tag.js');
...
var $export = require('./_export.js');
var $typed = require('./_typed.js');
var buffer = require('./_typed-buffer.js');
var anObject = require('./_an-object.js');
var toAbsoluteIndex = require('./_to-absolute-index.js');
var toLength = require('./_to-length.js');
var isObject = require('./_is-object.js');
var ArrayBuffer = require('./_global.js').ArrayBuffer;
var speciesConstructor = require('./_species-constructor.js');
...
if (require('./_descriptors.js')) {
  ...
  var ctx = require('./_ctx.js');
  var anInstance = require('./_an-instance.js');
  var propertyDesc = require('./_property-desc.js');
  var hide = require('./_hide.js');
  var redefineAll = require('./_redefine-all.js');
  var toInteger = require('./_to-integer.js');
  var toLength = require('./_to-length.js');
  ...
  var uid = require('./_uid.js');
  var wks = require('./_wks.js');
  var createArrayMethod = require('./_array-methods.js');
  var createArrayIncludes = require('./_array-includes.js');
  var speciesConstructor = require('./_species-constructor.js');
  ...
  var setSpecies = require('./_set-species.js');
  var arrayFill = require('./_array-fill.js');
  var arrayCopyWithin = require('./_array-copy-within.js');
  var $DP = require('./_object-dp.js');
  var $GOPD = require('./_object-gopd.js');
  var dP = $DP.f;
  var gOPD = $GOPD.f;
...
'use strict';
var redefineAll = require('./_redefine-all.js');
var getWeak = require('./_meta.js').getWeak;
var anObject = require('./_an-object.js');
var isObject = require('./_is-object.js');
var anInstance = require('./_an-instance.js');
var forOf = require('./_for-of.js');
...
var redefine = require('./_redefine.js');
var meta = require('./_meta.js');
var assign = require('./_object-assign.js');
var weak = require('./_collection-weak.js');
var isObject = require('./_is-object.js');
var validate = require('./_validate-collection.js');
var NATIVE_WEAK_MAP = require('./_validate-collection.js');
...
var $WeakMap = module.exports = require('./_collection.js')(WEAK_MAP, wrapper, methods, weak, true, true);
...
require('./_collection.js')(WEAK_SET, function (get) {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          // console.warn('loginData:', email, password)
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:8000/api/users/updateMyPassword' : 'http://127.0.0.1:8000/api/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  // console.warn('email:', email, password);
});
